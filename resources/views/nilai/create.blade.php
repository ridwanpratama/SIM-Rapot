...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('nilai.create') }}">Tambah Data Nilai</a></li>
    </ol>
@endsection
@section('content')
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>Kelola Nilai</strong> </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('nilai.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <select class="form-control select" id="siswa_id" name="siswa_id">
                                    ...
                                    @foreach (App\Siswa::all() as $siswa)
                                        <option value="{{ $siswa->id }}" data-rombel={{ $siswa->rombel }} data-rayon={{ $siswa->rayon->nama_rayon }} data-jurusan={{ $siswa->jurusan->nama_jurusan }}>{{ $siswa->nis }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <input class="form-control" id="rombel" type="text" name="rombel"
                                    placeholder="Rombel">
                            </div>
                        
                            <div class="col-md-4">
                                <input class="form-control" id="rayon" type="text" name="rayon_id"
                                    placeholder="Rayon">
                            </div>
