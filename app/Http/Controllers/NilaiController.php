...
class NilaiController extends Controller
{
    ...
    {
        $nilai = Nilai::find($id);
        $absen = Absen::where('id', $nilai->siswa_id)->first();
        $upd = Upd::where('id', $nilai->siswa_id)->first();
        $siswa = Siswa::where('id',$nilai->siswa_id)->first();
        
        // absen, upd sama data siswa tinggal tampilin di view
        // nilai belum ketemu caranya biar bisa dilooping sesuai siswa_id & mapel_id
